...
func WriteContext(ctx *model.Context, w io.Writer) error { _ = "STUB: not implemented"; return nil }

func WriteIncrement(ctx *model.Context, w io.Writer) error { _ = "STUB: not implemented"; return nil }
