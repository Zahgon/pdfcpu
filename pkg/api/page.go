...
func invalidPageDimension(v float64) bool { _ = "STUB: not implemented"; return false }
...
func PageCountFile(inFile string) (count int, err error) { _ = "STUB: not implemented"; return 0, nil }
