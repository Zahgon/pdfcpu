...
func removeTag(s, kw string) (string, bool) { _ = "STUB: not implemented"; return "", false }

func removeKeywords(metadata *[]byte) (bool, error) { _ = "STUB: not implemented"; return false, nil }
