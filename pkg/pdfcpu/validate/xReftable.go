...
func validateXRefTableContext(ctx *model.Context) error { _ = "STUB: not implemented"; return nil }
...
func nonStandardPageMode(s string) bool { _ = "STUB: not implemented"; return false }
